#!/usr/bin/env python3
# ──────────────────────────────────────────────────────
# ── Algunos sprites del Manic miner
# ──────────────────────────────────────────────────────
import curses
# import time
...
plot_sprite(0, 0, manic1)
plot_sprite(12, 0, manic2)
plot_sprite(24, 0, manic3)
plot_sprite(36, 0, manic2)

# ── Sprites de los ladrillos
for x in range(8):
    plot_sprite(x*8, 20, ladrillos)

# ── Sprite del suelo
for x in range(8):
    plot_sprite(x*8, 32, suelo)

# ── Sprite de la llave
plot_sprite(0, 40, llave)

# ── Sprite de la estalactita
plot_sprite(12, 40, estalactita)

pantalla_refresh()

stdscr.addstr(14, 0, "Pulsa una tecla")
